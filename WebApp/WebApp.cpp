...
//added by zb
		bserv::make_path("/zb_home", &zb_home,
			bserv::placeholders::session,
			bserv::placeholders::response),
		bserv::make_path("/zb_test_UI", &zb_test_UI,
			bserv::placeholders::session,
			bserv::placeholders::response),
		bserv::make_path("/zb_register_UI", &zb_register_UI,
			bserv::placeholders::session,
			bserv::placeholders::response),
		...
		bserv::make_path("/zb_be_musician", &zb_be_musician,
			...
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session),
		bserv::make_path("/zb_find_applicant", &zb_find_applicant,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			std::string{ "1" }),
		bserv::make_path("/zb_verify/<int>", &zb_verify,
			bserv::placeholders::request,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::_1),
		bserv::make_path("/zb_change_infornmation", &zb_change,
			bserv::placeholders::request,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::db_connection_ptr,
